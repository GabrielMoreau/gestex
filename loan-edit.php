...
$equipment_blacklist = get_loans_all_by_equipment_and_borrowed($pdo, $equipment_id);
$equipment_loans = get_loans_all_borrowed_by_equipment($pdo, $equipment_selected['id']);
