...
if ($truc == "instru")
echo "<title>Gestion des prêts du matériel instrumentation du LEGI</title>";
?>
...
<table cellpadding="2" cellspacing="0" border="0"
 style="text-align: left; width: 75%;" align="center">
  <tbody>
    <tr bgcolor="#f7d709">
...
<?php
 if ($truc == "instru")
  ...
  if ($truc == "pret")
        echo  "<td style=\"vertical-align: top;\"><h1>Gestion des prêts du matériel instrumentation du LEGI</h1>";   	
